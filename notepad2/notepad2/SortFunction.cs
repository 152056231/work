    ...
    class SortFunction
    {
        ...
        public void sort(Object sender1, FunctionEventArgs e2)
        {
            if (e2._choose == 2)
            {
                ...
                if (!System.IO.Directory.Exists(@"D:\C#\" + mynote.classify))
                {
                    string activeDir = @"D:\C#";
        ...
        public List<string> findCategory()
        {
            ...
            string[] folders = System.IO.Directory.GetDirectories(@"D:\C#");
        ...
        public void ModifySort(Object sender1, FunctionEventArgs e2)
        {
            if (e2._choose == 4)
            {
                ...
                if (!System.IO.Directory.Exists(@"D:\C#" + mynote.classify))
                {
                    try
                    {
                        System.IO.Directory.Delete(@"D:\C#\" + mynote.classify);
